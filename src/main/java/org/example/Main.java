...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bem vindo à Henrique Challenge!");
    ...
    Abaixo você pode ver uma implementação do submenu da soma básica
    */

    static Integer somaBasica(Integer valor1, Integer valor2) {

        // todo: faça o restante das validações e corrija possíveis erros
        if (valor1 == null || valor2 == null) {
            //throw new HenriqueException();
        }
    ...
    /*Array de Múltiplos
     * Esta função recebe 2 parâmetros: numero e tamanho e deve retornar um array dos múltiplos da variável 'número'
     * até que o array chegue no tamanho da variável 'tamanho'
     * Exemplo:
     *
     ...
     * Esta função recebe 3 parâmetros: 'numero1', 'numero2' e 'operacao'
     ...
     *
     * Notas:
     * Os parâmetros que recebem os números são recebidos como String e devem resultar em um valor int, eles podem
     ...
     * Os resultados da divisão serão arredondados para um valor inteiro sempre para baixo ex:
     *  8,99 se tornaria 8*/
    ...
    /*Pedra Papel Tesoura
     * Essa função recebe 2 parâmetros que são as opções dos dois jogadores
     * a função terá os seguintes retornos, baseado no resultado da partida:
     *           Jogador 1 Venceu! - Jogador 2 Venceu! - Empate!
     *
     * as opções dos jogadores podem ser pedra - papel - tesoura, porém o jogo deve entender independente se tem caps lock ou não
     * Se a opção for inválida devera jogar uma HenriqueException dizendo quais opções foram inválidas
     *
     * Exemplos:
     ...
     * pedraPapelTesoura("tesourinha", "tesourA") ➞ HenriqueException("Opção: tesourinha do Jogador 1 é inválida!")
     * pedraPapelTesoura("PAPEL", "robson") ➞ HenriqueException("Opção: robson do Jogador 2 é inválida!")
     * pedraPapelTesoura("teste", "aaaa") ➞ HenriqueException("Ambas opções são inválidas, melhorem!")
     *
     * Notas:
     * Pedra ganha de tesoura, papel ganha de pedra, tesoura ganha de papel
     * HenriqueException não tem um construtor que recebe uma mensagem de erro, crie um construtor
    ...
    /*Dígitos em comum
     * Essa função recebe um array de números inteiros válidos
